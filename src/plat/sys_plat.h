...
// 不同网卡配置，共2块网卡
#if 1
static const char netdev0_ip[] = "172.17.0.2";
static const char netdev0_gw[] = "172.17.0.1";
static const char friend0_ip[] = "172.17.0.3";
static const char netdev0_phy_ip[] = "172.17.0.1"; // 用于收发包的真实网卡ip地址，在qemu上不需要使用
static const char netdev0_mask[] = "255.255.255.0";
static const uint8_t netdev0_hwaddr[] = { 0x02, 0x42, 0x8b, 0xa5, 0x1d, 0x84 };
#else
static const char netdev0_ip[] = "172.17.0.2";
static const char netdev0_gw[] = "172.17.0.3";
static const char friend0_ip[] = "172.17.0.3";
static const char netdev0_phy_ip[] = "172.17.0.1"; // 用于收发包的真实网卡ip地址
static const char netdev0_mask[] = "255.255.255.0";
#endif
...
#elif 0 // defined(SYS_PLAT_WINDOWS)
...
#elif 1 // defined(SYS_PLAT_LINUX) || defined(SYS_PLAT_MAC)
